...
var result = {
  "INTJ": {
    ...
    "explain2": "외로움도 잘안타고 손해보지 않으려는 성격 때문에 쓸데없는<br>인간관계 안맺는다. '일만 잘하면되지' 라는 생각으로 이러한 성격에<br>만족하면서 살지만 가끔씩 활발하게 지내는 주위사람들을<br>보면 아주 가끔 '내가 비정상인가?'라는 생각이 들면서<br>깊은 사색에 빠지기도 한다. MBTI 성격 중 가장 독립적이고<br>단호하며 문제에 대하여 고집이 세다.",
    "img" : "intj.jpg"
  },
  "INTP": {
    "mbti": "INTP",
    ...
    "explain2": "INTP 유형은 전체 인구 3%정도의 극소수의 유형<br>세상에 관심이 없으면서도 관심이 많고, 사람 중심의 가치보다<br>아이디어에 관심이 많아 개인적인 인간관계 보다는 아이디어를<br>토론하는 소수의 가까운 사람들을 주위에 두고 있다.<br>극한의 효율을 좋아하기 때문에 예상가능한 범위 내에서 일이<br>일어나는 것을 좋아한다.",
    "img" : "intp.jpg"
  },
  "ENTJ": {
    "mbti": "ENTJ",
    ...
    "explain2": "남이 시켜서 하는게 아니라 일이 정말 좋아서 하는 유형이다.<br>그리고 이런 자신의 모습에 또 대견함을 느낀다.<br>설령 하기 싫은 일이라 할지라도 그 속에서 재미를 찾는다.<br>타인의성장에 성취감을 느끼고 개인의 성장이 자연스럽게 회사에<br>환원되기를 희망한다. 감투를 좋아하며 높은 자리에 앉고 싶어하며<br>그럴만한 능력도 있고 대부분이 그렇게 되게 이루는 편이다.",
    "img" : "entj.jpg"
  },
  "ENTP": {
    "mbti": "ENTP",
    "explain": "또라이라고? 고마워<br>뜨거운 논쟁을 즐기는 변론가",
    "job_ex" : "너도_될수있어_마크트웨인",
    "job" : "뛰어난 지적 탐구심을 가졌고, 독창적인 아이디어와<br>새로운 도전을 좋아하는 당신은<br>과학자 같은 분야부터 카피라이터 등의 직무와 잘 맞습니다.",
    "explain2": "\"착하다 = 호구같다\", \"또라이네 = 넌 참 특별해\" <br>로 해석되는 또라이다. 이해를 해야 공감하는 타입으로 논리적으로<br>납득이 안가면 절대 공감이 안된다. 무엇을 하든 평균이상으로<br>해내며 자존감이 높고 자신에 대한 확신이 있다.<br>타인의 생활에 관심이 적고, 내 생각과 주관을 가감없이 말하여<br>본의아니게 타인에게 상처를 줄때가 많다.",
    "img" : "entp.jpg"
  },
  "INFJ": {
    "mbti": "INFJ",
    ...
    "explain2": "모두를 혐오하지만 모두를 혐오하는 자신의 모습이 싫어<br>모두를 사랑하려고 하는 사람들.<br>다른 사람을 관찰하는게 취미이자 특기라서 남의 생각과 감정을<br>귀신같이 읽어내는 초월적 능력을 가졌다.<br>영혼없어 보인다는 말을 많이 듣고, 애매하게 외향적인척 하지만<br>스몰토크나 의미없는 대화에 쉽게 지친다.",
    "img" : "infj.jpg"
  },
  "INFP": {
    "mbti": "INFP",
    ...
    "explain2": "자신의 행동이 누군가에게 영향을 준다는 생각으로 어떤 행동을<br>하더라도 조심스럽게 진행한다. 지나치게 세심하고 디테일한 성격으로<br>주변 시선을 너무 의식하여 이런 부분이 스트레스로 자리잡기도 한다.<br>자신의 감정을 누구보다 잘 알고 있다. 감정적으로 가장 고통받기에<br>그것을 딛고 행복해질 가능성이 가장 높은 사람들이다.",
    "img" : "infp.jpg"
  },
  "ENFJ": {
    "mbti": "ENFJ",
    ...
    "explain2": "겉으로는 밝고 긍정적으로 보이지만 외로움도 잘 탄다. 주변에서는<br>친구 800명쯤 되는 인싸라고 부르지만 스스로 생각하는 친구는<br>5명 정도인 ENFJ. 매사에 적극적이며 책임감이 강해 누구보다<br>모임을 좋아하고 대화를 잘 이끌어 나간다. 기본적으로<br>사람을 좋아하며 마음이 약해 쉽게 동화되며, 동정심도 높다.",
    "img" : "enfj.jpg"
  },
  "ENFP": {
    "mbti": "ENFP",
    ...
    "explain2": "역동적이고 활달한 성격으로 처음 알게되는 사람들에게<br>호기심이 많다. 외면과 내면이 같아 가식, 위선이 없고,<br>주변을 행복하게 해주는 유형이다. 조증과 울증을 반복하며<br>회복탄력성이 좋다. 아이디어는 많으나 끝맺음 및 실행력이 부족하다.<br>하고 싶은게 많아 다양한 것을 시도하지만 싫증도 금방 난다.",
    "img" : "enfp.jpg"
  },
  "ISTJ": {
    "mbti": "ISTJ",
    ...
    "explain2": "신중한 성향으로 모든일에 꼼꼼하다.<br>객관적, 논리적으로 주변을 살피며 허상을 꿈꾸지 않는다.<br>현실적으로 이루어질 수 있는 범위 내에서 계획을 세우며<br>시간낭비를 굉장히 싫어한다. 반복되는 실수를 용납할 수 없으며,<br>이들의 리액션은 \"아 진짜요?\" 혹은 \"아 정말요?\" 가 전부이다.<br>새로운 것을 싫어하기 때문에 예고없는 변화에 가장 스트레스를 받는다.",
    "img" : "istj.jpg"
  },
  "ISFJ": {
    "mbti": "ISFJ",
    ...
    "explain2": "반복적이고 단조로운 업무에서 극한의 효율을 끌어내는 것을 즐기며<br>끊임없이 아이디어를 내고 사람들고 논의하는 상황을 싫어한다.<br>겉으로는 쿨한척, 신경안쓰는 척 하지만 속으로는 엄청 계산적이다.<br>대화할 때 흐름과 표정을 항상 체크하여 눈치가 빠르지만 종종<br>눈치없는 척을 하기도 합니다.",
    "img" : "isfj.jpg"
  },
  "ESTJ": {
    "mbti": "ESTJ",
  ...
  "ESFJ": {
    ...
    "explain2": "사교적으로 보여지지만 친구의 선이 명확해서 조금만 어색해도<br>같이 있기 힘들어한다. 친절하고 배려를 잘하여 어느 곳에서도 빠르게<br>적응하는 편이며 사람들 사이에서 중재자 역할을 잘 수행한다.<br>잡지식이 많아 어느 주제에서든 할얘기가 많고,<br>스몰토크를 좋아해서 누구한테나 쉽게 말을 걸 수있다.",
    "img" : "esfj.jpg"
  },
  "ISTP": {
    "mbti": "ISTP",
    ...
    "explain2": "노력 대비 효율이 좋아 만능 재주꾼이라고 불린다.<br>냉철한 판단을 잘하며 마음에 없는 소리를 못하고 앞뒤가 똑같아<br>솔직담백한 매력을 지닌다. 반항심이 높아 하지 말라고 하는 것은<br>더 하고 싶어지는 청개구리같은 모습을 보이기도 한다.<br>감정 표현을 잘 못하고, 말하는 것을 별로 안좋아하지만 관심있는<br>분야에서는 말이 많아진다.",
    "img" : "istp.jpg"
  },
  "ISFP": {
    "mbti": "ISFP",
  ...
  "ESTP": {
    "mbti": "ESTP",
    "explain": "습관적 플러팅<br>모험을 즐기는 사업가",
    "job_ex" : "너도_될수있어_트럼프",
    "job" : "논리적으로 분석해 현실적인 문제해결 방안을 모색하는 당신은<br>경찰관이나 소방관, 교도관 등 공적인 업무부터<br>엔지니어와도 궁합이 좋습니다.",
    "explain2": "친절함과 띠꺼움이 공존하는 ESTP.<br>효율성을 따지기 때문에 생각이 복잡하지 않고<br>단순, 간결, 명료 그 자체이다. 좋아하는 사람 앞에서는<br>뚝딱거리지만 관심 없는 사람에게는 저절로 플러팅하는 스타일이다.<br>거짓말을 잘 못해 필터링없이 말하여 주변인들은<br>종종 상처받을 때가 많다.",
    "img" : "estp.jpg"
  },
  "ESFP": {
    "mbti": "ESFP",
    ...
    "explain2": "어딜가나 밝고 리액션이 좋다는 말을 듣는다.<br>하이텐션에 노는것을 좋아하기 때문에 가벼운 이미지로 보일까<br>걱정도 하지만 속으로는 현실적인 고민도 많고 진지할 땐<br>진지한 스타일이다. 종종 타인을 기쁘게 하기 위해 이벤트를<br>준비하기도 한다. 이야기를 할때 요점만 전달하는 것이 어려워<br>부연설명을 덧붙일 때가 많다.",
    "img" : "esfp.jpg"
  }
};
